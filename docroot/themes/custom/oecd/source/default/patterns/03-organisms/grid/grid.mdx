...
import { PatternLoad, PatternPreview } from '@space-designsystem/storybook';
...
If you need additional configuration you can extends the columns configuration inside the `grid.space.yml`.
...
## Gutter
To configure the spacing between the columns use the gutter configuration in the grid.space.yml.
```yaml dark
  gutter:
    ...
